...
// Design tokens copied verbatim from the InsightFinder repo so this
// project visually reads as part of the same suite.
const config: Config = {
  darkMode: 'class',
  content: [
    './app/**/*.{js,ts,jsx,tsx}',
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        fadeUpSm: { from: { opacity: '0', transform: 'translateY(10px)' },        to: { opacity: '1', transform: 'translateY(0)' } },
      },
