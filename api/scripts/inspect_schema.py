"""Print all tables, column counts, indexes, and enums -- a quick post-
...
async def main() -> None:
    ...
    try:
        ...
        for r in rows:
            print(f"  {r['table_name']:<22} {r['columns']:>3} cols, {r['indexes']:>2} indexes")
